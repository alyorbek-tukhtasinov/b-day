...
const GRATITUDE_IMG = '/rasmlar/4.jpg';
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 5, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '0 32px', gap: '18px', maxWidth: '400px' }}>
        ...
        <motion.h2 {...fadeUp(0.15)} style={{
          ...
          color: '#F8F0E3', margin: 0, lineHeight: 1.25,
          textShadow: '0 0 40px rgba(201,169,110,0.2)',
        }}>
          {`Hayotimni quvonchga to‘ldirib, har onimda yonimda turganing uchun ming bor Rahmat!`}
        </motion.h2>
        ...
        <motion.p {...fadeUp(0.45)} style={{
          ...
          Chaqirimlar qanchalik uzoq bo‘lmasin, sen hamisha yuragimning tubida, eng yaqinimdasan. O‘sha sehrli ovozing eng og‘ir damlarda qalbimga orom berib, yashashga kuch bag‘ishlovchi yagona najotimdir.
        </motion.p>
        ...
        <motion.p {...fadeUp(0.75)} style={{
          ...
          {`Qayda bo‘lmay, har nafasimda yoningdaman`}
        </motion.p>
