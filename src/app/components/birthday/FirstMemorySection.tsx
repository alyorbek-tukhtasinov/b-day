...
const FIRST_MEMORY_IMG = '/rasmlar/2.jpg';
...
export const FirstMemorySection: React.FC = () => {
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 5, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '0 32px', gap: '18px', maxWidth: '400px' }}>
        ...
        <motion.h2 {...fadeUp(0.15)} style={{
          ...
          Bizning taqdir yo‘limiz boshlangan lahza
        </motion.h2>
        ...
        <motion.p {...fadeUp(0.45)} style={{
          ...
          O‘sha birinchi uchrashuv hamon ko‘z oldimda. Ilk kulishingdan vaqt to‘xtab, olam sukunatga cho‘mgandi. Oddiygina tabassuming butun borlig‘imni, butun hayotimni tubdan o‘zgartirib yuborishini o‘shanda qalbim his qilgandi.
        </motion.p>
        ...
        <motion.p {...fadeUp(0.75)} style={{
          ...
          Va o‘sha kundan boshlab...<br />
          hayotim faqat sen bilan go‘zal.
        </motion.p>
